...
$notify_count = $conn->query('select count(*) from tbl_notification')->fetchColumn();
            ...
            <div class="app-header-content"> 
                ...
                <div class="col-auto">
                    <a id="sidepanel-toggler" class="sidepanel-toggler d-inline-block d-xl-none" href="#">
                        <svg style="color: gray;" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" role="img"><title>Menu</title><path stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M4 7h22M4 15h22M4 23h22"></path></svg>
                    </a>
                </div><!--//col-->
                ...
                <div class="app-search-box col">
                    <form class="app-search-form" id="search-form">   
                        <input type="text" id="search-input" placeholder="ค้นหา..." name="search" class="form-control search-input" onkeyup="showResult(this.value)">
                        <button type="button" class="btn search-btn btn-primary" value="Search"><i class="fas fa-search"></i></button> 
                        <!-- Live Search -->
                        <div style="background-color: #fff; border-radius:5px; width: 100%;" class="livesearch" id="livesearch"></div>
                    </form>
                ...
                <div class="app-utilities col-auto">
                    <div class="app-utility-item app-notifications-dropdown dropdown">    
                        <a class="dropdown-toggle no-toggle-arrow" id="notifications-dropdown-toggle" data-bs-toggle="dropdown" href="" role="button" aria-expanded="false" title="Notifications">
                            ...
                            <span class="icon-badge"><?php echo $notify_count; ?></span>
                        </a><!--//dropdown-toggle-->
                        <div class="dropdown-menu p-0" aria-labelledby="notifications-dropdown-toggle">
                            ...
                            <div class="dropdown-menu-content">
                                <div class="item p-3">
                                    ...
                                    $stmt = $conn->query("SELECT * FROM tbl_notification");
                                    $stmt->execute();
                                    $data = $stmt->fetchAll();
                                    ...
                                    <div class="card p-3 mb-2">
                                        <div class="row gx-2 justify-content-between align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <div class="meta p-3"><?php echo $content['notify_date_time'] ?></div>
                                            </div><!--//col-->
                                            <hr class="mt-1 mb-1">
                                            <div class="col">
                                                <div class="info"> 
                                                    <div class="desc"><?php echo $content['notify_content'] ?></div>
                                                </div>
                                            </div><!--//col-->
                                        </div><!--//row-->
                                    </div>
                    ...
                    <div class="app-utility-item <?php echo isset($_SESSION['user_login']) ? 'd-none' : '' ?>">
                        <a href="?page=setting" title="Settings">
                    ...
                    <div class="app-utility-item app-user-dropdown dropdown">
                        <a style="text-decoration: none;" class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="" role="button" aria-expanded="false">
                            <img style="border-radius: 50%;" src="include/uploads/<?php echo $row['img']?>" alt="user profile">
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                            <li><a class="dropdown-item"><strong>ชื่อผู้ใช้ :</strong> <span class="text-success"><?php echo $row['username']; ?></span></a></li>
                            <li><a class="dropdown-item"><strong>สถานะ :</strong> <span class="text-success"><?php echo $row['role']; ?></span></a></li>
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    <li class="nav-item">
                        <a class="nav-link <?php echo !isset($_GET['page']) && empty($_GET['page']) ? 'active' : '' ?>" href="home.php">
                            <span class="nav-icon">
                    ...
                    <!-- <liขข class="nav-item">
                        <a class="nav-link <+?php echo isset($_GET['page']) && $_GET['page'] == 'demo' ? 'active' : '' ?>" href="?page=demo">
                            <span class="nav-icon">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                                    <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
                    ...
                    <li class="nav-item <?php echo isset($_SESSION['user_login']) ? 'd-none' : '' ?>">
                        <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page'] == 'member' ? 'active' : '' ?>" href="?page=member">
                            <span class="nav-icon">
